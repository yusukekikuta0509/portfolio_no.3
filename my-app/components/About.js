        ...
        <div className="flex-1">
          <h2 className="text-6xl  mb-4 text-gray-900 text-center`">
            ...
            <p className="text-gray-800 text-xl">
              初めまして！フリーランスエンジニアの菊田佑輔です。ReactとNext.jsを中心にフロントエンド開発を行っています。趣味は音楽鑑賞と読書です。
            </p>
            ...
            >
              <p className="mt-4 text-gray-600 text-lg">
                元々は音楽大学生だった私ですが、音楽理論が好きなことから、プログラミングに興味を持ち、独学でプログラミングを始めました。
                現在は、フロントエンド開発に特化していますが、バックエンドやインフラなどの分野にも興味を持っており、幅広いスキルを持っています。
                まだまだ経験が浅いですが、持ち前の自走力と技術のキャッチアップの速度を武器にこれからも成長していきたいと思っています。
              </p>
            </motion.div>
